<%-- 
    Document   : eliminar
    Created on : 10/11/2019, 04:59:40 PM
    Author     : HP
--%>

<%@page import="com.store.action.actor.DeleteAction"%>
...
<jsp:include page="../menu.html"/>
    <body style=" background-image: url('../eliminarusuario.jpg');
          ...
          ">
        <h2 style="text-align: center; color: #000209;">Eliminación de Actor</h2>
	...
	<s:else>
        ...
        <div Class="col" Style="color:white;
            ...
            <s:a cssClass="btn btn-warning" action="listarActores" cssStyle="color:white;
